...
Texture::Texture(char * data, size_t image_size, int width, int height, const std::string& path) : image_size(image_size), width(width), height(height), data(data), Resource("",path)
{
	LoadInMemory();
}
