...
public:
    ...
    {
        //std::printf("> IDebugDrawOpenGLImplementation::setupShaderPrograms()\n");
...
const char* IDebugDrawOpenGLImplementation::linePointVertShaderSrc = "\n"
"#version 150\n"
"\n"
"in vec3 in_Position;\n"
...
const char* IDebugDrawOpenGLImplementation::linePointFragShaderSrc = "\n"
"#version 150\n"
"\n"
"in  vec4 v_Color;\n"
...
const char* IDebugDrawOpenGLImplementation::textVertShaderSrc = "\n"
"#version 150\n"
"\n"
"in vec2 in_Position;\n"
...
const char* IDebugDrawOpenGLImplementation::textFragShaderSrc = "\n"
"#version 150\n"
"\n"
"in vec2 v_TexCoords;\n"
"in vec4 v_Color;\n"
